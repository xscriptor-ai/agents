...
description: Architecture and design patterns — ADR format, C4 model, design patterns
  catalog, architecture decision records template, system context diagrams
---
