...
description: Cross-language performance patterns — caching, database optimization,
  profiling, memory management, async patterns, bundle optimization, Core Web Vitals
---
