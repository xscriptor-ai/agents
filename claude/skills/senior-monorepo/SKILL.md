...
description: Monorepo management — tool comparison (Nx, Turborepo, Lerna, pnpm workspaces),
  shared config, dependency management, build caching, CI optimization, versioning
---
