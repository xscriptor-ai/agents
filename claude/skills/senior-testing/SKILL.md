---
name: senior-testing
description: Cross-language testing strategies — unit vs integration vs E2E, mocking,
  test data management, flaky test handling, coverage metrics, CI integration
---
