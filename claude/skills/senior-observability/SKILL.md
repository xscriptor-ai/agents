...
description: Observability patterns — structured logging, distributed tracing (OpenTelemetry),
  metrics (Prometheus, Grafana), alerting, dashboards, SLO/SLI definitions
---
