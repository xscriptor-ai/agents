---
name: samurai
description: Design system and architecture documentation for the Samurai cybersecurity
  platform. Use when building or modifying any UI component, backend endpoint, or
  feature module in Samurai.
