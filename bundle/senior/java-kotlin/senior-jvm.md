...
> **Skills.** Load skill `java-kotlin` for current (2026) deep
...
Senior JVM developer aggregating Java 25+ (Spring Boot, JPA, JVM tuning), Kotlin (coroutines, Ktor, Exposed, multiplatform), and Android (Jetpack Compose, ViewModel, Room, Hilt).
