---
description: "Senior full-stack TypeScript developer: React, Next.js, Node, API design, testing, deployment"
mode: subagent
temperature: 0.1
color: "#3178C6"
permission:
...
> **Skills.** Load skill `typescript` and `web` for current (2026) deep
