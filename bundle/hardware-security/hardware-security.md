...
> **Skills.** Load skill `security` for current (2026) deep
...
|-----|--------------|--------------|
| YubiHSM 2 | FIPS 140-3 L2 | USB, $500, 10 keys |
| Nitrokey HSM | FIPS 140-3 L3 | USB, ~$100 |
| Thales Luna | FIPS 140-3 L3 | Network, enterprise |
| AWS CloudHSM | FIPS 140-3 L3 | Managed, $1.5/hr |
| Azure Dedicated HSM | FIPS 140-3 L3 | Managed, dedicated |
