...
### JVM Options
```bash
java -XX:+UseZGC \                    # Low-pause GC (default in Java 25+ for < 100GB heap)
...
Use Java 25+ features (records, sealed classes, pattern matching, virtual threads) as the baseline.
